...
$getDematLink = getDematLink_list();

if ($per['demat_account']['add'] == 0) { ?>
    <script>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>View Demat Links</h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo SITEPATH; ?>admin/dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">View Demat Links</li>
                </ol>
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="addLinkModalLabel">Add New Demat Link</h4>
                            </div>
                            <div class="modal-body">
                                <form id="addLinkForm" action="<?php echo SITEPATH; ?>admin/action/demat_link.php?action=save" method="post">
                        ...
                        function confirmDelete(id) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    var deleteUrl = "<?php echo SITEPATH; ?>admin/action/demat_link.php?action=del&id=" + id;
