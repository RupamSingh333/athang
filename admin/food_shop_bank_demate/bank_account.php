                ...
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="exportable" align="center" class="table table-bordered table-condensed table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($customer_list as $rows) {
                                ...
                                $bank_acc_opening_approvedby = getuser_byID($rows['bank_acc_opening_approvedby']);
                  ...
                  <td><a href="javascript:void(0)">
                      <img src="<?php echo SITEPATH; ?><?php echo ($rows['cust_selfie']) ? 'upload/Images/' . $rows['cust_selfie'] : NOIMAGE; ?>" style="width: 80px;height: 80px;border-radius: 20px;">
                                    ...
                                    <td>
                                        <?php echo ($rows['b_acc_name_of_link']); ?>
                                    </td>

                                    <td>
                                        <?php if ($rows['b_acc_screenshot']) { ?>
                                            <a href="<?php echo SITEPATH; ?><?php echo ($rows['b_acc_screenshot']) ? 'upload/Images/' . $rows['b_acc_screenshot'] : NOIMAGE; ?>" target="_blank">View Customer Signature</a>
                                        <?php } ?>
                                    </td>


                                    <td><?php echo $bank_acc_opening_approvedby['first_name']; ?></td>

                                    <td>

                                        <?php if ($rows['bank_acc_opening'] == 'Y') { ?>
                                            <i class="fa fa-check-circle" title="Approved" style="color: green;"></i>
                                        <?php } else if ($rows['bank_acc_opening'] == 'N') { ?>
