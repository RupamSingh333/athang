...
if ($empRole != Vendor) {
    ...
    $getAllBankAccounts = getAllBankAccountsById($_SESSION['AdminLogin']);
}
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if (!empty($rows['b_acc_screenshot'])) {
                                            $filenames = explode(',', $rows['b_acc_screenshot']);
                                            foreach ($filenames as $key => $filename) {
                                                $filename = trim($filename);
                                                $filePath = SITEPATH . 'upload/Images/' . $filename;
                                        ?>
                                                <a href="<?php echo $filePath; ?>" target="_blank">View Bank Account-<?php echo ++$key; ?></a><br>
                                        <?php
                                            }
                                        }
                                        ?>
